...
const LandingPageBody = () => {
  return (
    <div
      className="z-10 absolute flex flex-col h-auto justify-center items-center w-full text-gray-300"
      style={{ top: "30%" }}
    >
      ...
      <p className="hidden sm:block text-center lg:text-md md:text-sm leading-8 text-gray-200 break-word">
